...
{
	int i, j;
	instrumentation_type cleanup_time;

	START_TIMING(cleanup_t, cleanup_time);
	...
	END_TIMING(cleanup_t, cleanup_time)
	PRINT_TIME();
...
void _nvp_init2(void)
{
	...
	instrumentation_type init_time;

	START_TIMING(init_t, init_time);
